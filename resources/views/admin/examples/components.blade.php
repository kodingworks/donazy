<x-admin::app>
    <x-admin::page-title value="Components" />
    ...
    <div class="p-4 bg-white rounded-lg shadow-md dark:bg-gray-800 mb-8">
        <label class="block text-sm">
            ...
            <x-admin::input type="text" placeholder="Jane Doe" />
        </label>

        <label class="block text-sm mt-4">
            <x-admin::label value="Password" />
            <x-admin::input type="password" placeholder="1234" error />
            <x-admin::input-helper error value="Your password is too short." />
        </label>

        <div class="mt-4 text-sm">
            <x-admin::label value="Account Type" />
            <div class="mt-2">
                <x-admin::radio label="Personal" name="type" value="1" />
                <x-admin::radio label="Business" name="type" value="1" />
            </div>
        </div>

        <label class="block mt-4 text-sm">
            <x-admin::label value="Requested Limit" />
            <x-admin::select>
                <option>$1,000</option>
                <option>$5,000</option>
        ...
        <label class="block mt-4 text-sm">
            <x-admin::label value="Multiselect" />
            <x-admin::select multiple>
        ...
        <label class="block mt-4 text-sm">
            <x-admin::label value="Message" />
            <x-admin::textarea rows="3" placeholder="Enter some long form content." />
        </label>

        <div class="flex mt-6 text-sm">
            <x-admin::checkbox name="policy" value="1">
                I agree to the
